...
NARR = [
    (0.3, "Hola, soy Martín, el asistente de Central Mutuos ConCreces. Te voy a mostrar cómo funciona el módulo de Daniela Galindo paso a paso."),
    ...
    (43.3, "Paso cuatro: Daniela revisa cada documento en pantalla, sin descargarlo, y lo acepta o rechaza con un clic."),
    ...
    (75.3, "Paso siete: Daniela confirma y el set viaja a ConCreces con un solo clic."),
    (83.4, "Así de simple y rápido opera el módulo de Daniela Galindo. Todo validado, todo en orden, listo para ConCreces."),
]
