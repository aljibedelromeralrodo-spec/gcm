...
async def extraer_datos_financieros(texto, cliente=""):
    ...
    try:
        ...
        system = (
            ...
            "renta_liquida (renta MENSUAL considerada en pesos chilenos CLP, número o null. "
            "REGLA MESA: por cada mes suma el sueldo/alcance LÍQUIDO más los ANTICIPOS o "
            "avances descontados de ese mes, y promedia sobre los meses disponibles — la "
...
async def clasificar_y_extraer(texto, filename=""):
    ...
    try:
        ...
        system = (
            ...
            "INTEGRIDAD DE DATOS — PROHIBIDO INVENTAR: nunca rellenes, deduzcas ni "
            "inventes información que no esté LITERALMENTE en el texto. Ante la duda, "
            "deja el campo vacío ('' o null) para revisión manual. "
