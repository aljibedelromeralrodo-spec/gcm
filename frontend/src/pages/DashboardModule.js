  ...
  return (
    <div className="module-content" data-testid="dashboard-module">
      ...
      {cobrosResumen?.resumen && (
        <div data-testid="panel-cobros-tasacion" style={{ background: "rgba(15,23,42,0.6)", border: "1px solid rgba(212,175,55,0.25)", borderRadius: 4, padding: "1rem 1.3rem", marginBottom: "1rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "0.7rem" }}>
            {[
              ...
              <div key={i} data-testid={`cobros-stat-${i}`} style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(212,175,55,0.2)", borderRadius: 4, padding: "0.7rem 1rem", textAlign: "center" }}>
