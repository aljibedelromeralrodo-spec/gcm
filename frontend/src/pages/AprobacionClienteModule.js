...
export default function AprobacionClienteModule({ onNavigate }) {
  ...
  return (
    <div style={{ padding: "1.5rem", color: "var(--white)", maxWidth: "1000px" }} data-testid="aprobacion-module">
      {onNavigate && (
        <button data-testid="aprobacion-volver" onClick={() => { marcarRegreso("clientes"); onNavigate("clientes"); }} style={{ marginBottom: "1rem", background: "transparent", border: "1px solid rgba(212,175,55,0.5)", color: "var(--gold)", borderRadius: 0, padding: "0.45rem 1rem", fontWeight: 700, cursor: "pointer" }}>
      ...
      <div style={card}>
        ...
        <div style={{ position: "relative" }}>
          ...
          {resultados.length > 0 && (
            <div style={{ position: "absolute", top: "110%", left: 0, right: 0, background: "rgba(14,14,16,0.9)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "0px", zIndex: 20, overflow: "hidden" }}>
              {resultados.map((r, i) => (
      ...
      {preview && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }} onClick={() => setPreview(null)}>
          <div style={{ background: "#fff", borderRadius: "0px", maxWidth: "720px", width: "100%", maxHeight: "88vh", overflow: "auto" }} onClick={e => e.stopPropagation()} data-testid="aprobacion-preview-modal">
            <div style={{ padding: "0.8rem 1.2rem", background: "rgba(14,14,16,0.9)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, zIndex: 5 }}>
