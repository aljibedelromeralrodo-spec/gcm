  ...
  return (
    <div>
      <input
        ...
        style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #d4d4d8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }}
      />
      {preview && (
    ...
    <div className="clientes-module" data-testid="clientes-module">
      ...
      {view === "detail" && currentFolder && (
        <div data-testid="clientes-detail">
          ...
          {finOpenId === currentFolder.id && (
            <div data-testid={`fin-detail-panel`} style={{ background: "rgba(14,165,233,0.08)", border: "1px solid #0ea5e9", borderRadius: 10, padding: "0.9rem", marginBottom: "0.8rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.5rem" }}>
                {currentFolder.source_email && (() => {
                  ...
                  return (
                    <div data-testid="fin-origen" style={{ gridColumn: "1 / -1", background: "#dbeafe", border: "1px solid #93c5fd", borderRadius: 6, padding: "0.5rem 0.7rem", fontSize: 12 }}>
                ...
                <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Inmobiliaria</b>
                  <input type="text" value={finDraft.inmobiliaria || ""} onChange={(e) => setFinDraft({ ...finDraft, inmobiliaria: e.target.value })} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                </label>
                <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Proyecto</b>
                  <input type="text" value={finDraft.proyecto || ""} onChange={(e) => setFinDraft({ ...finDraft, proyecto: e.target.value })} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                </label>
                <label style={{ fontSize: 12, gridColumn: "1 / -1", color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Tipo de operación</b>
                  <select value={finDraft.con_subsidio ? "con" : "sin"} onChange={(e) => setFinDraft({ ...finDraft, con_subsidio: e.target.value === "con" })} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }}>
                ...
                <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Tipo propiedad</b>
                  <select value={finDraft.tipo_propiedad || ""} onChange={(e) => setFinDraft({ ...finDraft, tipo_propiedad: e.target.value })} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }}>
                ...
                <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Valor propiedad (UF)</b>
                  <input type="number" step="0.01" value={finDraft.valor_propiedad || ""} onChange={(e) => setFinDraft({ ...finDraft, valor_propiedad: e.target.value })} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                </label>
                {finDraft.con_subsidio && (
                  <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Subsidio (UF)</b>
                    <input type="number" step="0.01" value={finDraft.monto_subsidio || ""} onChange={(e) => setFinDraft({ ...finDraft, monto_subsidio: e.target.value })} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                  </label>
                )}
                {finDraft.con_subsidio && (
                  <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Ahorro (UF)</b>
                    <input type="number" step="0.01" value={finDraft.ahorro || ""} onChange={(e) => setFinDraft({ ...finDraft, ahorro: e.target.value })} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                  </label>
                )}
                {!finDraft.con_subsidio && (
                  <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Pie (UF)</b>
                    <input type="number" step="0.01" value={finDraft.monto_pie || ""} onChange={(e) => setFinDraft({ ...finDraft, monto_pie: e.target.value })} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                  </label>
                )}
                <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}><b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Monto crédito (UF)</b>
                  <input type="number" step="0.01" value={finDraft.monto_credito || ""} onChange={(e) => setFinDraft({ ...finDraft, monto_credito: e.target.value })} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                </label>
      ...
      {view === "ajustes" && (
        <div data-testid="clientes-ajustes">
          ...
          <div style={{ padding: "1rem", background: "rgba(59,130,246,0.08)", border: "1px solid #3b82f6", borderRadius: 10, marginBottom: "1rem", fontSize: "0.88rem", lineHeight: 1.6 }}>
                  ...
                  <div key={f.id} className="clientes-card" style={{ padding: "1rem", flexDirection: "column", alignItems: "stretch", borderLeft: cr.manual_override ? "3px solid #8b5cf6" : "" }} data-testid={`ajuste-${f.id}`}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem", gap: "0.5rem", flexWrap: "wrap" }}>
                      <h4 style={{ margin: 0 }}>
                        ...
                        {cr.manual_override && (
                          <span data-testid={`manual-badge-${f.id}`} style={{ background: "#ede9fe", color: "#6d28d9", padding: "2px 8px", borderRadius: 12, fontSize: 11, fontWeight: 700, marginLeft: 8 }}>
                      ...
                      {!isEditing && (
                        <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                          <span style={{ background: cr.is_request ? "#dcfce7" : "#fee2e2", color: cr.is_request ? "#166534" : "#991b1b", padding: "2px 8px", borderRadius: 12, fontSize: 12, fontWeight: 700 }}>
                            {cr.is_request ? "✓ Solicitud" : "✗ No"}
                          </span>
                          <span style={{ background: "#fef3c7", color: "#92400e", padding: "2px 8px", borderRadius: 12, fontSize: 12 }}>{cr.client_type || "?"}</span>
                          <span style={{ background: "#e0e7ff", color: "#3730a3", padding: "2px 8px", borderRadius: 12, fontSize: 12 }}>{sub.tipo || "?"}</span>
                          {cod.has_codeudor && <span style={{ background: "#fce7f3", color: "#9d174d", padding: "2px 8px", borderRadius: 12, fontSize: 12 }}>+ codeudor {cod.name || "s/n"}</span>}
                    ...
                    {isEditing && (
                      <div data-testid={`edit-form-${f.id}`} style={{ background: "rgba(139,92,246,0.08)", border: "1px solid #8b5cf6", borderRadius: 10, padding: "0.9rem", marginBottom: "0.6rem", display: "grid", gap: "0.7rem", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))" }}>
                        <label style={{ fontSize: 12 }}>
                          <b style={{ display: "block", marginBottom: 4 }}>¿Es solicitud?</b>
                          <select value={editDraft.is_request ? "si" : "no"} onChange={(e) => setEditDraft({ ...editDraft, is_request: e.target.value === "si" })} data-testid={`edit-is-request-${f.id}`} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8" }}>
                        ...
                        <label style={{ fontSize: 12 }}>
                          ...
                          <select value={editDraft.client_type} onChange={(e) => setEditDraft({ ...editDraft, client_type: e.target.value })} data-testid={`edit-client-type-${f.id}`} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8" }}>
                        ...
                        <label style={{ fontSize: 12 }}>
                          ...
                          <select value={editDraft.subsidy_tipo} onChange={(e) => setEditDraft({ ...editDraft, subsidy_tipo: e.target.value })} data-testid={`edit-subsidy-${f.id}`} style={{ width: "100%", padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8" }}>
                        ...
                        <label style={{ fontSize: 12 }}>
                          ...
                          <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                            ...
                            <input type="text" placeholder="Nombre codeudor" value={editDraft.codeudor_name || ""} onChange={(e) => setEditDraft({ ...editDraft, codeudor_name: e.target.value, codeudor_has: true })} data-testid={`edit-codeudor-name-${f.id}`} style={{ flex: 1, padding: "0.35rem", borderRadius: 6, border: "1px solid #d4d4d8", fontSize: 12 }} />
                          </div>
                        </label>
                    ...
                    {/* ARCHIVOS TOOLBAR */}
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 6, padding: "0.4rem 0.6rem", background: "rgba(15,23,42,0.4)", borderRadius: 8, border: "1px solid rgba(148,163,184,0.15)" }}>
                      ...
                      <button
                        ...
                        style={{ background: "rgba(34,197,94,0.15)", border: "1px solid rgba(34,197,94,0.5)", color: "#4ade80", borderRadius: 6, padding: "4px 10px", cursor: "pointer", fontSize: 12 }}
                      ...
                      <button
                        ...
                        style={{ background: "rgba(250,204,21,0.15)", border: "1px solid rgba(250,204,21,0.5)", color: "#facc15", borderRadius: 6, padding: "4px 10px", cursor: "pointer", fontSize: 12, fontWeight: 600 }}
                      ...
                      <button
                        ...
                        style={{ background: "rgba(168,85,247,0.15)", border: "1px solid rgba(168,85,247,0.5)", color: "#c084fc", borderRadius: 6, padding: "4px 10px", cursor: selectionCount(f.id) < 1 ? "not-allowed" : "pointer", opacity: selectionCount(f.id) < 1 ? 0.5 : 1, fontSize: 12 }}
                      ...
                      <button
                        ...
                        style={{ background: "rgba(59,130,246,0.18)", border: "1px solid rgba(59,130,246,0.5)", color: "#93c5fd", borderRadius: 6, padding: "4px 10px", cursor: "pointer", fontSize: 12 }}
                      ...
                      {selectionCount(f.id) > 0 && (
                        <button
                          ...
                          style={{ background: "transparent", border: "1px solid rgba(148,163,184,0.3)", color: "#94a3b8", borderRadius: 6, padding: "4px 10px", cursor: "pointer", fontSize: 11 }}
                    ...
                    {finOpenId === f.id && (
                      <div data-testid={`fin-panel-${f.id}`} style={{ background: "rgba(14,165,233,0.08)", border: "1px solid #0ea5e9", borderRadius: 10, padding: "0.9rem", marginBottom: "0.6rem" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.6rem" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.5rem" }}>
                          <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}>
                            ...
                            <input type="text" value={f.nombre} readOnly style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, background: "#f1f5f9", border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600 }} />
                          </label>
                          <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}>
                            <b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>RUT</b>
                            <input type="text" value={f.rut || ""} readOnly style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, background: "#f1f5f9", border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600 }} />
                          </label>
                          <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}>
                            <b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Proyecto</b>
                            <input type="text" value={finDraft.proyecto || ""} onChange={(e) => setFinDraft({ ...finDraft, proyecto: e.target.value })} data-testid={`fin-proyecto-${f.id}`} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                          </label>
                          <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}>
                            <b style={{ display: "block", color: "#dc2626", fontWeight: 800 }}>Inmobiliaria</b>
                            <input type="text" value={finDraft.inmobiliaria || ""} onChange={(e) => setFinDraft({ ...finDraft, inmobiliaria: e.target.value })} data-testid={`fin-inmobiliaria-${f.id}`} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }} />
                          </label>
                          <label style={{ fontSize: 12, gridColumn: "1 / -1", color: "#dc2626", fontWeight: 700 }}>
                            ...
                            <select value={finDraft.con_subsidio ? "con" : "sin"} onChange={(e) => setFinDraft({ ...finDraft, con_subsidio: e.target.value === "con" })} data-testid={`fin-subsidy-${f.id}`} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }}>
                              <option value="con">CON subsidio (DS1 / DS19)</option>
                              <option value="sin">SIN subsidio</option>
                            </select>
                          </label>
                          <label style={{ fontSize: 12, color: "#dc2626", fontWeight: 700 }}>
                            ...
                            <select value={finDraft.tipo_propiedad || ""} onChange={(e) => setFinDraft({ ...finDraft, tipo_propiedad: e.target.value })} data-testid={`fin-tipo-prop-${f.id}`} style={{ width: "100%", padding: "0.4rem 0.5rem", borderRadius: 6, border: "1px solid #94a3b8", fontSize: 13, color: "#000", fontWeight: 600, background: "#fff" }}>
                    ...
                    {(f.subfolders || []).map(s => (
                      <details key={s.name} style={{ background: "rgba(255,255,255,0.03)", borderRadius: 8, padding: "0.4rem 0.7rem", marginTop: 4 }}>
                            ...
                            return (
                              <li key={ff.name} style={{ opacity: 0.9, display: "flex", alignItems: "center", gap: 6, padding: "3px 4px", background: sel ? "rgba(250,204,21,0.08)" : "transparent", borderRadius: 4 }}>
                                ...
                                <button
                                  ...
                                  style={{ background: "rgba(59,130,246,0.15)", border: "1px solid rgba(59,130,246,0.4)", color: "#3b82f6", borderRadius: 4, padding: "2px 8px", cursor: "pointer", fontSize: 11 }}
                                >
                                  <i className="fa fa-eye"></i>
                                </button>
          ...
          >
            <div style={{
              ...
              <a
                ...
                style={{ background: "rgba(148,163,184,0.15)", color: "#e2e8f0", padding: "5px 12px", borderRadius: 6, textDecoration: "none", fontSize: 12 }}
              >
              ...
              <button
                ...
                style={{ background: "rgba(239,68,68,0.2)", color: "#fca5a5", border: "1px solid rgba(239,68,68,0.4)", borderRadius: 6, padding: "5px 12px", cursor: "pointer", fontSize: 12 }}
              >
            ...
            <div style={{ flex: 1, background: "#1e293b", overflow: "hidden" }}>
              ...
              {previewFile.mime === "other" && (
                <div style={{ padding: "2rem", textAlign: "center", color: "#94a3b8" }}>
                  ...
                  <a href={previewFile.url.replace("?inline=true", "")} target="_blank" rel="noreferrer" style={{ color: "#3b82f6", textDecoration: "underline" }}>
                    Descargar archivo
                  </a>
                </div>
              )}
            ...
            <div onClick={(e) => e.stopPropagation()} style={{ background: "#0f172a", color: "#e2e8f0", borderRadius: 12, width: "min(760px, 96vw)", maxHeight: "94vh", overflow: "auto", border: "1px solid rgba(148,163,184,0.25)", boxShadow: "0 20px 60px rgba(0,0,0,0.6)" }}>
              ...
              <div style={{ padding: "1rem 1.1rem", display: "grid", gap: "0.75rem" }}>
                ...
                {m.modalidad === "inmobiliaria" && (
                  <div style={{ background: "rgba(139,92,246,0.08)", border: "1px solid rgba(139,92,246,0.3)", borderRadius: 8, padding: "0.7rem 0.9rem", display: "grid", gap: "0.6rem" }}>
                      ...
                      {m.archivos.map((a, i) => {
                        ...
                        <label key={a.ruta} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12.5, cursor: permitido ? "pointer" : "not-allowed", opacity: permitido ? 1 : 0.45 }}>
                          ...
                          <button type="button" data-testid={`tasacion-adj-ver-${i}`}
                            ...
                            style={{ background: "rgba(59,130,246,0.15)", border: "1px solid #3b82f6", color: "#d4af37", borderRadius: 6, padding: "2px 10px", fontSize: 11, fontWeight: 700, cursor: "pointer", flexShrink: 0, opacity: 1 }}>
                    ...
                    {brokers.flatMap(b => (b.emails || []).map(em => ({ nombre: b.nombre, em })))
                      ...
                      .map((x, i) => (
                        <button key={i} data-testid={`cc-add-broker-${i}`} onClick={() => set("cc", [m.cc, x.em].filter(Boolean).join(", "))}
                          style={{ background: "rgba(59,130,246,0.12)", border: "1px solid rgba(59,130,246,0.4)", color: "#d4af37", borderRadius: 12, padding: "3px 10px", fontSize: 11.5, cursor: "pointer" }}>
                          + {x.nombre} ({x.em})
                        </button>
                      ))}
                  </div>
                        ...
                        {docsEstudio.map((a, i) => (
                          <div key={a.ruta} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12.5 }}>
                            ...
                            <button type="button" data-testid={`estudio-doc-ver-${i}`}
                              ...
                              style={{ background: "rgba(59,130,246,0.15)", border: "1px solid #3b82f6", color: "#d4af37", borderRadius: 6, padding: "2px 10px", fontSize: 11, fontWeight: 700, cursor: "pointer", flexShrink: 0 }}>
                              <i className="fa fa-eye" /> Ver
                            </button>
                          </div>
                        ))}
        ...
        return (
          <div data-testid="email-modal" onClick={closeEmailModal} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9998, padding: "3vh 3vw" }}>
            <div onClick={(e) => e.stopPropagation()} style={{ background: "#0f172a", color: "#e2e8f0", borderRadius: 12, width: "min(760px, 96vw)", maxHeight: "94vh", overflow: "auto", border: "1px solid rgba(148,163,184,0.25)", boxShadow: "0 20px 60px rgba(0,0,0,0.6)" }}>
              ...
              <div style={{ padding: "1rem 1.1rem", display: "grid", gap: "0.75rem" }}>
                <div style={{ background: "rgba(30,41,59,0.7)", borderRadius: 8, padding: "0.7rem 0.9rem", fontSize: 13, lineHeight: 1.5 }}>
                ...
                <label style={{ fontSize: 12 }}>
                  ...
                  <textarea
                    ...
                    style={{ width: "100%", padding: "0.5rem", borderRadius: 6, border: "1px solid rgba(148,163,184,0.3)", background: "#1e293b", color: "#e2e8f0", fontSize: 13, resize: "vertical" }}
                  />
                </label>

                <div style={{ background: "rgba(30,41,59,0.5)", borderRadius: 8, padding: "0.6rem 0.9rem", fontSize: 12, display: "grid", gap: 6 }}>
              ...
              <div style={{ padding: "0.8rem 1.1rem", borderTop: "1px solid rgba(148,163,184,0.2)", display: "flex", gap: 8, justifyContent: "flex-end" }}>
                <button onClick={closeEmailModal} disabled={emailModal.sending} style={{ background: "transparent", border: "1px solid rgba(148,163,184,0.3)", color: "#94a3b8", borderRadius: 6, padding: "6px 14px", cursor: "pointer", fontSize: 13 }}>Cancelar</button>
                {!emailModal.preview ? (
                  <button onClick={previewClientEmail} disabled={emailModal.sending || !emailModal.to} data-testid="btn-email-preview"
                    style={{ background: !emailModal.to ? "rgba(148,163,184,0.15)" : "rgba(250,204,21,0.2)", border: `1px solid ${!emailModal.to ? "rgba(148,163,184,0.3)" : "rgba(250,204,21,0.6)"}`, color: !emailModal.to ? "#94a3b8" : "#facc15", borderRadius: 6, padding: "6px 14px", cursor: (emailModal.sending || !emailModal.to) ? "not-allowed" : "pointer", fontSize: 13, fontWeight: 600 }}
                  ...
                  <>
                    <button onClick={() => setEmailModal({ ...emailModal, preview: null })} disabled={emailModal.sending}
                      style={{ background: "transparent", border: "1px solid rgba(148,163,184,0.3)", color: "#94a3b8", borderRadius: 6, padding: "6px 14px", cursor: "pointer", fontSize: 13 }}>
                      <i className="fa fa-pencil" /> Editar
                    </button>
      ...
      {missingDocsModal && (() => {
        ...
        return (
          <div data-testid="missing-docs-modal" onClick={closeMissingDocsModal} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9998, padding: "3vh 3vw" }}>
            <div onClick={(e) => e.stopPropagation()} style={{ background: "#0f172a", color: "#e2e8f0", borderRadius: 12, width: "min(760px, 96vw)", maxHeight: "94vh", overflow: "auto", border: "1px solid rgba(239,68,68,0.5)", boxShadow: "0 20px 60px rgba(0,0,0,0.6)" }}>
              <div style={{ padding: "0.9rem 1.1rem", borderBottom: "1px solid rgba(148,163,184,0.2)", display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ padding: "1rem 1.1rem", display: "grid", gap: "0.75rem" }}>
                {p && (
                  <>
                    <div style={{ background: "rgba(239,68,68,0.1)", borderRadius: 8, padding: "0.7rem 0.9rem", fontSize: 13 }}>
                    ...
                    <label style={{ fontSize: 12 }}><b style={{ display: "block", marginBottom: 4 }}>Destinatario *</b>
                      <input type="email" value={missingDocsModal.to} onChange={(e) => setMissingDocsModal({ ...missingDocsModal, to: e.target.value })} onBlur={refreshMissingDocsPreview} data-testid="missing-to" style={{ width: "100%", padding: "0.5rem", borderRadius: 6, border: "1px solid rgba(148,163,184,0.3)", background: "#1e293b", color: "#e2e8f0", fontSize: 13 }} />
                    </label>
                    <label style={{ fontSize: 12 }}><b style={{ display: "block", marginBottom: 4 }}>Mensaje adicional (opcional)</b>
                      <textarea value={missingDocsModal.extra} onChange={(e) => setMissingDocsModal({ ...missingDocsModal, extra: e.target.value })} onBlur={refreshMissingDocsPreview} rows={2} data-testid="missing-extra" style={{ width: "100%", padding: "0.5rem", borderRadius: 6, border: "1px solid rgba(148,163,184,0.3)", background: "#1e293b", color: "#e2e8f0", fontSize: 13 }} />
                    </label>
                    <div>
                      ...
                      <div style={{ background: "#fff", color: "#111", borderRadius: 8, padding: "0.6rem 0.8rem", maxHeight: 280, overflow: "auto", border: "1px solid rgba(148,163,184,0.3)" }}
                  ...
                  <>
                    ...
                    <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end", borderTop: "1px solid rgba(148,163,184,0.15)", paddingTop: "0.8rem" }}>
                      <button onClick={scanReparos} disabled={m.scanning} data-testid="btn-reparos-scan"
                        style={{ background: "rgba(59,130,246,0.15)", border: "1px solid #3b82f6", color: "#d4af37", borderRadius: 6, padding: "8px 14px", cursor: "pointer", fontSize: 13, fontWeight: 700 }}>
