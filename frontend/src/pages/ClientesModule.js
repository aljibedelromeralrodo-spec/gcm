    ...
    <div className="clientes-module" data-testid="clientes-module">
      ...
      {view === "list" && (
        <div data-testid="clientes-list">
          <ClientesFilters searchQuery={searchQuery} setSearchQuery={setSearchQuery}
            syncing={syncing} cloudSync={cloudSync} syncMsg={syncMsg}
            loadEmails={loadEmails} loadAjustes={loadAjustes} setShowCreate={setShowCreate}
            setForzarModal={setForzarModal} setCompromisoLibre={setCompromisoLibre}
            folderTab={folderTab} setFolderTab={setFolderTab}
            countClientes={countClientes} countEscrituracion={countEscrituracion} />
